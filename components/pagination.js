export default class Pagination {
  ...
  getTemplate () {
    return `
      <div class="wrapper-pagination">
        <div class="left-arrow" data-element="nav-prev">
            <div class="_round-shape">
        ...
        ${this.getPages ()}
        <div class="right-arrow" data-element="nav-next">
          <div class="_round-shape">
            <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  getPages () {
    return `
      <div class="pagination-numbers" data-element="pagination">
  ...
  getPageTemplate (pageIndex = 0) {
    ...
    return `
      <a><div class="_round-shape active-class ${isActive}" data-page-index="${pageIndex}">${pageIndex+1}</div></a>
    `;
  }
  ...
  setPage (pageIndex = 0) {
    ...
    const activePage = this.element.querySelector('._round-shape.active-class.active');
  ...
  addEventListeners () {
    ...
    pagesList.addEventListener('click', event => {
      const pageItem = event.target.closest('._round-shape.active-class');
